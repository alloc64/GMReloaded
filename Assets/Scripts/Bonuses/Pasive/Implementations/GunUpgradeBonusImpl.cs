...
{
	public class GunUpgradeBonusImpl : IBonusPasiveDispatch
	{
		public override bool Dispatch(Bonus bonus, RobotEmilNetworked robotParent, bool permanent)
		{
			...
			robotParent.AddSecondaryAttackType(RobotEmil.SecondaryAttackType.GunUpgrade);
		...
		public override void StopDispatch()
		{
			...
			{
				robotParent.RemoveSecondaryAttackType(RobotEmil.SecondaryAttackType.GunUpgrade);
			}
		}
	}
}
